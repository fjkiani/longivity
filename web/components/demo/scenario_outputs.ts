// Auto-generated from production API — 2026-05-17
// Source: POST https://longivity-backend.onrender.com/api/v1/longevity/{endpoint}
...
export const SCENARIO_OUTPUTS: Record<string, unknown> = {
  ...
  "supplementary_biomarkers": {},
  "hallmark_narrative": {},
  "scoring_calibration": "PhenoAge full panel \u2014 compound relevance uses mortality-validated PhenoAge linear-term magnitudes for accelerating hallmarks; supplementary tier only when no PhenoAge signal for that hallmark.",
  ...
  "provenance": {
    ...
    "timestamp": "2026-05-17T03:51:02.560771+00:00",
    "run_id": "0ac18c92-83de-4662-8828-02f50a76c1d4"
  },
  ...
  "longevity_prs": {
    ...
    "honest_caveat": "Polygenic scores for complex traits and parental lifespan typically explain only a small fraction of phenotypic variance (often on the order of R\u00b2 \u2248 0.02\u20130.08 depending on endpoint, cohort, and PRS construction). This score is for research context and must not be interpreted as deterministic individual risk.",
    "provenance": {
      "weights_source": {
        "pmid": "31735170",
        "journal": "eLife",
        "article": "39856",
        "data_file": "https://cdn.elifesciences.org/articles/39856/elife-39856-table2-data2-v2.xlsx",
        "sheet": "iGWAS 1% FDR"
      },
      "panel_definition": "27 SNPs with largest |Years| effect from Timmers et al. 2019 parental lifespan GWAS (eLife 39856 supplementary table 2, sheet 'iGWAS 1% FDR'). APOE-region variants excluded from this panel (APOE diplotype remains in genetic_annotator). Effect size = Years column (parental lifespan change in years per copy of A1). GRCh37 coordinates from same table.",
      "panel_version": "1.0.0"
    }
  },
  ...
  "action_items": [
    {
      ...
      "detail": "maintain current protocol"
    }
  ],
  "data_completeness": {
    "phenoage_components": 9,
  ...
  "provenance": {
    ...
    "compound_source": "longevity_compound_hallmark_map.json (PMID-verified links where flagged)",
    "biomarker_source": "biomarker_hallmark_map.json + phenoage_gompertz_coefficients_levine2018.json",
    "timestamp": "2026-05-17T03:51:10.413062+00:00",
    "run_id": "0cac2f1b-a0f8-4baa-b402-c05e56ffca0b",
    "modules": [
  ...
  "level0": {
    ...
    "phenoage_analysis": {
      ...
      "conversion_notes": {
        ...
        "creatinine": "converted creatinine_mg_dl -> \u00b5mol/L (*88.42)",
        "glucose_serum": "converted glucose_mg_dl -> mmol/L (/18.018)",
        "crp_log": "hsCRP/CRP mg/L=0.4 \u2192 CRP mg/dL=0.04000000000000001 (\u00f710) \u2192 ln(mg/dL)=-3.218876; aliases: crp_mg_l, hscrp, hs_crp_mg_l, hsCRP_mg_l (case-insensitive keys)"
      },
      "source_pmid": "29676998",
      "calibration_note": "Coefficients from Gompertz PH model (Supplementary Table S1 / Table 1, PMID 29676998). PhenotypicAge and 10-year mortality require all nine biomarkers in published units plus chronological age; partial inputs yield per-component linear terms only. CrisPRO threshold comparison (biomarker_hallmark_map.json; not PhenoAge classification)"
    },
  ...
  "dna_repair_compound_queries_added": []
},
  "metabolic-storm": {
  "status": "SUCCESS",
  "level": 0,
  ...
  "provenance": {
    ...
    "compound_source": "longevity_compound_hallmark_map.json (PMID-verified links where flagged)",
    "biomarker_source": "biomarker_hallmark_map.json + phenoage_gompertz_coefficients_levine2018.json",
    "timestamp": "2026-05-17T03:51:27.929842+00:00",
    "run_id": "ac382728-5103-4bd8-b269-7b4088efcfe2"
  },
  "disclaimer": "Research Use Only. Biological age estimation follows published PhenoAge transforms; acceleration labels are CrisPRO UX thresholds, not PhenoAge classifications. Do not use for clinical decisions without a qualified clinician."
},
  "partial-panel": {
  ...
  "supplementary_biomarkers": {},
  "hallmark_narrative": {},
  "scoring_calibration": "PhenoAge partial panel \u2014 compound relevance uses accelerating PhenoAge components where present; otherwise normalized supplementary biomarker tiers with explicit per-match labels.",
  "compound_recommendations": [],
  "data_completeness": {
  ...
  "provenance": {
    ...
    "compound_source": "longevity_compound_hallmark_map.json (PMID-verified links where flagged)",
    "biomarker_source": "biomarker_hallmark_map.json + phenoage_gompertz_coefficients_levine2018.json",
    "timestamp": "2026-05-17T03:51:28.124933+00:00",
    "run_id": "9de57a98-06a6-4450-ad4f-33ff5d3aa670"
  },
  "disclaimer": "Research Use Only. Biological age estimation follows published PhenoAge transforms; acceleration labels are CrisPRO UX thresholds, not PhenoAge classifications. Do not use for clinical decisions without a qualified clinician."
},
  "longevity-outlier": {
  ...
  "provenance": {
    ...
    "compound_source": "longevity_compound_hallmark_map.json (PMID-verified links where flagged)",
    "biomarker_source": "biomarker_hallmark_map.json + phenoage_gompertz_coefficients_levine2018.json",
    "timestamp": "2026-05-17T03:51:28.344879+00:00",
    "run_id": "44c16276-6bd0-4384-8793-4d29a0831a94",
    "modules": [
      "longevity_phenoage_level0",
      "genetic_annotator (optional)",
      "dna_repair_scorer (optional)",
  ...
  "level0": {
    ...
    "phenoage_analysis": {
      ...
      "conversion_notes": {
        ...
        "creatinine": "converted creatinine_mg_dl -> \u00b5mol/L (*88.42)",
        "glucose_serum": "converted glucose_mg_dl -> mmol/L (/18.018)",
        "crp_log": "hsCRP/CRP mg/L=0.3 \u2192 CRP mg/dL=0.03 (\u00f710) \u2192 ln(mg/dL)=-3.506558; aliases: crp_mg_l, hscrp, hs_crp_mg_l, hsCRP_mg_l (case-insensitive keys)"
      },
      "source_pmid": "29676998",
      "calibration_note": "Coefficients from Gompertz PH model (Supplementary Table S1 / Table 1, PMID 29676998). PhenotypicAge and 10-year mortality require all nine biomarkers in published units plus chronological age; partial inputs yield per-component linear terms only. CrisPRO threshold comparison (biomarker_hallmark_map.json; not PhenoAge classification)"
    },
